...
export function renderOrderSummary() {
    ...
    document.querySelectorAll('.save-quantity-link').forEach((link) => {
        link.addEventListener('click', () => {
            ...
            let newQuantity = Number(document.querySelector(`.js-cart-item-container-${productId} .quantity-input`).value);
    ...
    document.querySelectorAll('.quantity-input').forEach(inputField => {
        inputField.addEventListener('keypress', function(event) {
            if(event.key == "Enter") {
                ...
                document.querySelector(`.js-cart-item-container-${inputField.dataset.productId} .save-quantity-link`).click();
            }
        })
    });
